...
let lowerCaps = nameInCaps.lowercased()
let lowerName = name.lowercased()

if lowerCaps == lowerName {
    print ("\(lowerCaps) and \(lowerName) are the same. ")
} else {
   print("\(lowercaps) and \(lowerName) are not the same.")
}
...
if junior.hasSuffix("Jr.") {
 print (" Whoopty Do we have found a second generation name!"
       }
