...
let moreAccurateResult = 10.00/3.00
...
// Add 5 using the compound assignment operator
number += 5
print(number)

// Multiply by 2 using the compound assignment operator
number *= 2
print(number)
...
let castDouble = Int(doubleConstant)
let result = castDouble * integerConstant
print(result)
/*:
